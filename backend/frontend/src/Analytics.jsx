        ...
        datasets: [
          {
            label: "Placements",
            data: [80, 60, 70, 50],
            backgroundColor: ["#f9df75", "#28a745", "#89c2ff", "#ff6384"],
            borderRadius: 6,
          },
        ],
      },
          ...
          tooltip: {
            callbacks: {
              label: (context) => {
                ...
                if (label) label += ": ";
                if (context.parsed.y !== null) label += context.parsed.y + " Placements";
                return label;
              },
            },
          },
  ...
  return (
    <div className="analytics-page">
      <style>{`
        ...
        .analytics-page { display: flex; flex-direction: column; min-height: 100vh; width: 100vw; }
        .header {
        ...
        .sidebar-link.active { background-color: #007bff; color: white; box-shadow: 0 4px 6px rgba(0,123,255,0.2); }
        ...
        .card h3 { color: #007bff; margin: 0 0 1rem 0; font-weight: 600; font-size: 1.5rem; }

        .progress-bar-group { margin-bottom: 1.5rem; }
        .progress-bar-group p { margin: 0 0 0.5rem 0; font-weight: 500; }
        .progress-bar { background-color: #e9ecef; border-radius: 10px; overflow: hidden; height: 10px; }
        .progress { height: 100%; background-color: #007bff; transition: width 0.5s ease; }

        .donut-legend { display: flex; justify-content: center; flex-wrap: wrap; margin-top: 1.5rem; }
        .donut-legend span { display: flex; align-items: center; margin: 0.5rem 1rem; font-weight: 500; }
        .donut-legend span i { width: 12px; height: 12px; display: inline-block; margin-right: 8px; border-radius: 50%; }
        ...
        @media (max-width: 768px) {
          ...
          .logo { font-size: 5vw; }
          .nav-link { font-size: 3vw; margin-top: 10px; }
          .main-layout { flex-direction: column; }
          .sidebar { width: 100%; border-right: none; border-bottom: 1px solid #e0e6ed; box-shadow: 0 2px 5px rgba(0,0,0,0.05); }
          .sidebar-nav { flex-direction: row; justify-content: space-around; padding: 1rem 0; }
          .sidebar-link { font-size: 3vw; min-height: auto; }
          ...
          <div className="analytics-grid">
            ...
            <div className="card">
              ...
              <div className="donut-legend">
                <span><i style={{ backgroundColor: "#f9df75" }}></i>Eligible</span>
                <span><i style={{ backgroundColor: "#89c2ff" }}></i>Interviewed</span>
                <span><i style={{ backgroundColor: "#28a745" }}></i>Placed</span>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="progress-bar-group">
                <p>Registrations</p>
                <div className="progress-bar"><div className="progress" style={{ width: "80%", backgroundColor: "#007bff" }}></div></div>
              </div>
              <div className="progress-bar-group">
                <p>Eligible Matches</p>
                <div className="progress-bar"><div className="progress" style={{ width: "70%", backgroundColor: "#28a745" }}></div></div>
              </div>
              <div className="progress-bar-group">
                <p>Scheduled Interviews</p>
                <div className="progress-bar"><div className="progress" style={{ width: "50%", backgroundColor: "#ffc107" }}></div></div>
              </div>
              <div className="progress-bar-group">
                <p>Placements</p>
                <div className="progress-bar"><div className="progress" style={{ width: "40%", backgroundColor: "#dc3545" }}></div></div>
              </div>
            </div>
